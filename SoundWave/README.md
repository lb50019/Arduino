...
while True:
	...
	cv2.waitKey(1)
```
To make this code accessible, this simple snippets needs to be written in a form of a class, which enables simple import of all its functionality. After proper rearrangement, the code now looks like this:
...
class handDetector():
	...
	def findHands(self, img, draw = True):																	# static_image_mode (default: False), max_num_hands (default: 2), min_detection_confidence (default: 0.5) and min_tracking_confidence (0.5)
